class Entity {
    ...
    update(d) {
        ...
        //if (this.type == "player")
        //    console.log(`${this.pos[0]} + ${this.vel[0]} * ${this.speed} * ${d}`)

        //if (this.type == "npc_enemy_1" || this.type == "npc_ally_1") {

            this.pos[0] = this.pos[0] + this.vel[0] * this.speed * d;
            this.pos[1] = this.pos[1] + this.vel[1] * this.speed * d;
        //}
